...
CREATE TABLE shareit.comment (
    id int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    text varchar NOT NULL,
    item_id int8 NOT NULL,
    author_user_id int8 NOT NULL,
    created timestamp NOT NULL,
    CONSTRAINT comment_pk PRIMARY KEY (id),
    CONSTRAINT comment_item_fk FOREIGN KEY (item_id) REFERENCES shareit.item(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT comment_user_fk FOREIGN KEY (author_user_id) REFERENCES shareit.users(id) ON DELETE CASCADE ON UPDATE CASCADE
);